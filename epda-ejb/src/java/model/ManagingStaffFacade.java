...
public class ManagingStaffFacade extends AbstractFacade<ManagingStaff> {
    ...
    public ManagingStaff findByEmail(String email) {
        try {
            return em.createQuery("SELECT m FROM ManagingStaff m WHERE m.email = :email", ManagingStaff.class)
    ...
    public Map<String, Long> getAgeDistributionFromIC() {
        try {
            ...
            List<String> icList = em.createQuery(
                    "SELECT c.ic FROM ManagingStaff c WHERE c.ic IS NOT NULL", String.class)
                    .getResultList();
    ...
    public Map<String, Long> getGenderDistribution() {
        try {
            ...
            List<String> genderList = em.createQuery(
                    "SELECT c.gender FROM ManagingStaff c WHERE c.gender IS NOT NULL", String.class)
                    .getResultList();
