...
public class CustomerFacade extends AbstractFacade<Customer> {
    ...
    // Additional method to retrieve all customers if needed
    public List<Customer> findAll() {
        return em.createQuery("SELECT c FROM Customer c", Customer.class).getResultList();
    }
    
    public List<DeliveryRatingFeedback> findDeliveryFeedbackByCustomer(Customer customer) {
        try {
            return em.createQuery("SELECT d FROM DeliveryRatingFeedback d WHERE d.customer = :customer", DeliveryRatingFeedback.class)
    ...
    public Map<String, Long> getAgeDistributionFromIC() {
        try {
            ...
            List<String> icList = em.createQuery(
                    "SELECT c.ic FROM Customer c WHERE c.ic IS NOT NULL", String.class)
                    .getResultList();
    ...
    public Map<String, Long> getGenderDistribution() {
        try {
            ...
            List<String> genderList = em.createQuery(
                    "SELECT c.gender FROM Customer c WHERE c.gender IS NOT NULL", String.class)
                    .getResultList();
