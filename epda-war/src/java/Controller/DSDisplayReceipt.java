 ...
 * @author vinni
 */
@WebServlet(name = "DSDisplayReceipt", urlPatterns = {"/DSDisplayReceipt"})
public class DSDisplayReceipt extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("dsDisplayReceipt.jsp").forward(request, response);
    }
