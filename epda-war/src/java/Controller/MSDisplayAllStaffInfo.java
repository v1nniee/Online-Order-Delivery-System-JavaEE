 ...
 * @author vinni
 */
@WebServlet(name = "MSDisplayAllStaffInfo", urlPatterns = {"/MSDisplayAllStaffInfo"})
public class MSDisplayAllStaffInfo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        // Fetch all Managing Staff and Delivery Staff
