 ...
 * @author vinni
 */
@WebServlet(name = "MSDisplayProductInfo", urlPatterns = {"/MSDisplayProductInfo"})
public class MSDisplayProductInfo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        // Add base64 encoding for product images
        for (Product product : productList) {
            if (product.getProductImage() != null) {
                String base64Image = Base64.getEncoder().encodeToString(product.getProductImage());
                product.setBase64Image(base64Image); // Set transient field for use in JSP
            } else {
